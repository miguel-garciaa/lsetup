...
# ==============================================================================
# INSTALADOR LARAVEL 13 + PHP 8.4 + PostgreSQL 18 + Redis 7 + Filament 5
...
echo "=== 9. FILAMENT 5 + SOCIALITE + SHIELD + SPATIE MEDIA LIBRARY ==="
...
echo "=== 10. OCTANE + FRANKENPHP + SERVICIO SYSTEMD ==="
